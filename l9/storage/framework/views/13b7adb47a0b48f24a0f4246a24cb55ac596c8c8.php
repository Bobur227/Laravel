    ...
    <div>
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
            ...
            <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-blue-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
                ...
                <nav class="mt-10">
                    <a href="<?php echo e(route('admin.admin_users.index')); ?>"
                        ...
                        <div x-data="{ dropdownOpen: false }" class="relative">
                            <button @click="dropdownOpen = ! dropdownOpen"
                                ...
                                <img class="h-full w-full object-cover"
                                     src="<?php echo e('/storage/posts/IMG_7576.JPG'); ?>"
                                     alt="Your avatar">
                            </button>
...
<?php /**PATH C:\Users\Acer ПК\Desktop\Laravel\l9\resources\views/layout/admin.blade.php ENDPATH**/ ?>